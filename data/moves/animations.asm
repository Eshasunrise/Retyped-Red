...
DragonbreathAnim:
	battle_anim EMBER, SUBANIM_1F, 1, 6
	battle_anim EMBER, SUBANIM_11, 1, 6
	db -1 ; end
...
LungeAnim:
	battle_anim QUICK_ATTACK, SUBANIM_0F, 0, 6
	db -1 ; end
...
SludgeBombAnim:
	battle_anim SLUDGE, SUBANIM_13, 1, 6
	battle_anim SLUDGE, SUBANIM_42, 1, 4
	db -1 ; end

HeadSmashAnim:
	battle_anim LEECH_SEED, SE_MOVE_MON_HORIZONTALLY
	battle_anim TAKE_DOWN, SE_SHAKE_SCREEN
	battle_anim NO_MOVE, SE_RESET_MON_POSITION
	db -1 ; end
...
FlashCannonAnim:
	battle_anim LEECH_SEED, SE_LIGHT_SCREEN_PALETTE
	battle_anim GLARE, SE_DARK_SCREEN_FLASH
	battle_anim BARRAGE, SUBANIM_42, 1, 4
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
