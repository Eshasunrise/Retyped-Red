...
; Route 8
	...
	db 22, PARAS, CLEFAIRY, VENONAT, 0
; Celadon Gym
	db 23, PARAS, FARFETCHD, 0
...
; Route 21
	db 31, TENTACOOL, POLIWRATH, TENTACRUEL, 0
...
; Fuchsia Gym
	db 31, KOFFING, GRIMER, EKANS, BEEDRILL, 0
	db 34, GRIMER, LICKITUNG, 0
; Victory Road 2F
	db 48, MR_MIME, 0
; Unused
	db 33, HYPNO, 0
; Fuchsia Gym
	db 38, LICKITUNG, 0
	db 34, KOFFING, LICKITUNG, 0

TamerData:
; Fuchsia Gym
	db 34, NIDORINO, ARBOK, 0
	db 33, ARBOK, NIDORINA, ARBOK, 0
; Viridian Gym
	db 43, RHYHORN, 0
	db 39, SANDSLASH, DODRIO, 0
; Victory Road 2F
...
; Viridian Gym
	db 40, CUBONE, MAROWAK, 0
	db 43, ONIX, 0
	db 38, GEODUDE, GRAVELER, GOLEM, 0
; Victory Road 2F
...
ProfOakData:
; Oak's Lab
	db $FF, 66, TAUROS, 67, NIDOKING, 68, VICTREEBEL, 68, NINETALES, 69, BLASTOISE, 70, MEW, 0
	db $FF, 66, TAUROS, 67, NIDOKING, 68, NINETALES, 68, STARMIE, 69, VENUSAUR, 70, MEW, 0
	db $FF, 66, TAUROS, 67, NIDOKING, 68, VICTREEBEL, 68, STARMIE, 69, CHARIZARD, 70, MEW, 0
...
; Silph Co. 10F
	db 29, KOFFING, AERODACTYL, 0
; Mansion 3F
	db 33, MAGNEMITE, MAGNEMITE, MAGNETON, 0
; Mansion B1F
	db 34, OMANYTE, KABUTO, 0
...
; Viridian Gym
	db $FF, 45, RHYHORN, 42, DUGTRIO, 44, NIDOQUEEN, 45, KANGASKHAN, 50, RHYDON, 0
...
; Pokémon Tower 7F
	...
	db 23, MEOWTH, ZUBAT, RATTATA, RATICATE, 0
; Unused
...
; Victory Road 3F
	...
	db 45, PARASECT, DEWGONG, CLEFABLE, FARFETCHD, CHANSEY, VENOMOTH, 0
; Unused
...
BrunoData:
	db $FF, 53, ONIX, 55, ELECTABUZZ, 55, PRIMEAPE, 56, POLIWRATH, 58, MACHAMP, 0
...
KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, TENTACRUEL, 43, WEEZING, 0

BlaineData:
	db $FF, 42, GROWLITHE, 40, MAGMAR, 42, RAPIDASH, 47, ARCANINE, 0

SabrinaData:
	db $FF, 38, HYPNO, 37, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, 0
...
; Pokémon Tower 6F
	...
	db 24, GASTLY, 0
; Saffron Gym
	db 34, ABRA, KADABRA, 0
	db 38, GOLDUCK, 0
	db 33, DROWZEE, DROWZEE, HYPNO, 0

AgathaData:
	db $FF, 56, NINETALES, 56, MAROWAK, 55, PARASECT, 58, GOLBAT, 60, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, CHARIZARD, 56, SEADRA, 60, AERODACTYL, 62, DRAGONITE, 0
