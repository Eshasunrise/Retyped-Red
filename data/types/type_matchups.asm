TypeEffects:
	...
	db PSYCHIC_PHYS, FIGHTING,     SUPER_EFFECTIVE
	db PSYCHIC_PHYS, POISON,       SUPER_EFFECTIVE
	db PSYCHIC_PHYS, DARK,         NO_EFFECT
	db PSYCHIC_PHYS, PSYCHIC_TYPE, NOT_VERY_EFFECTIVE
	db -1 ; end
